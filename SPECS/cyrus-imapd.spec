...
* Fri Dec 12 2025 Martin Osvald <mosvald@redhat.com> - 3.8.3-10
- Create directory structure under /var using tmpfiles.d

* Fri Dec 05 2025 Martin Osvald <mosvald@redhat.com> - 3.8.3-9
- Remove sscg option --package from cyrus-imapd-init.service

* Mon Aug 11 2025 František Hrdina <fhrdina@redhat.com> - 3.8.3-8
- Update location of fmf plans

* Wed Jan 15 2025 Joe Orton <jorton@redhat.com> - 3.8.3-7
- update the default cyrus.conf to enable idled Resolves: RHEL-61130

* Tue Oct 29 2024 Troy Dawson <tdawson@redhat.com> - 3.8.3-6
- Bump release for October 2024 mass rebuild:

* Thu Aug 08 2024 Troy Dawson <tdawson@redhat.com> - 3.8.3-5
- Bump release for Aug 2024 perl mass rebuild

* Mon Jun 24 2024 Troy Dawson <tdawson@redhat.com> - 3.8.3-4
- Bump release for June 2024 mass rebuild

* Wed Jun 12 2024 František Hrdina <fhrdina@redhat.com> - 3.8.3-3
...
- Fix CVE-2024-34055
- Fix wrong symlinks to imtest utilities
- Convert to %%autorelease and %%autochangelog

* Thu Apr 18 2024 Martin Osvald <mosvald@redhat.com> - 3.8.2-2
- Remove dependency on transfig package (RHEL-32632)
